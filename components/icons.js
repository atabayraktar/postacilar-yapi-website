    ...
    <>
        ...
        <div className="desktop-components">
          <div className="component-container">
            <div className="row icons">
              <div className="col-3 icons-centered"><div className="about-us-logo"><img src="/homepage-info/logo-1.webp" /></div></div>
              <div className="col-3 icons-centered"><div className="about-us-logo"><img src="/homepage-info/logo-2.webp" /></div></div>
              <div className="col-3 icons-centered"><div className="about-us-logo"><img src="/homepage-info/logo-3.webp" /></div></div>
              <div className="col-3 icons-centered"><div className="about-us-logo"><img src="/homepage-info/logo-4.webp" /></div></div>
            </div>
      ...
      <div className="container">
        <div className="mobile-components">
          <div className="component-container">
            <div className="row icons">
              <div className="col-6 icons-centered"><div className="about-us-logo"><img src="/homepage-info/logo-1.webp" /></div></div>
              <div className="col-6 icons-centered"><div className="about-us-logo"><img src="/homepage-info/logo-2.webp" /></div></div>
            </div>
            <div className="row icons-description">
            ...
            <div className="row icons">
              <div className="col-6 icons-centered"><div className="about-us-logo"><img src="/homepage-info/logo-3.webp" /></div></div>
              <div className="col-6 icons-centered"><div className="about-us-logo"><img src="/homepage-info/logo-4.webp" /></div></div>
            </div>
            <div className="row icons-description">
