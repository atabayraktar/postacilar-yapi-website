...
export default function PostacilarLife() {
  ...
  return (
    <>
      {showMediumModal && (
        <ZoomModal size="modal" zoomRef={refx} imageSrc={modalSrc} />
      )}
      {showVModal && (
        <ZoomModal size="modal-35" zoomRef={refx} imageSrc={modalSrc} />
      )}
      ...
      <Header
        refs={[projectsSectionRef, contactSectionRef, aboutUsSectionRef]}
      />
        ...
        <div className="row">
          <div className="col-12 col-md-6">
            <div className="row">
              ...
              <div className="detail-sub-title">
                ...
                <span className="detail-sub-title-stick">
                  <div>|</div>
                </span>
                Hakkında
              </div>
          ...
          <div className="col-12 col-md-6 nova-right-col prestige-img-component-desktop">
            <div className="row" style={{ justifyContent: "center" }}>
              <div
                className="col-12 nova-main-image"
                style={{ width: "650px" }}
              >
                <Swiper
                  modules={[Navigation]}
        ...
        <div className="row">
          ...
          <div className="col-12 col-md-8">
            ...
            <div className="images zoomable-img">
              <div className="row align-items-end">
                ...
                <div className="col-6 mt-3 mt-md-0 col-md-5">
                  <img
                    onClick={() => {
                      setShowModal(true);
                      setModalSrc("/2-yatak-odası.jpg");
                    }}
                    width="100%"
                    height="auto"
                    src="/2-yatak-odası.jpg"
                  />
                </div>
              ...
              <div
                className="row prestige-bottom-part-second-row mb-5"
              ...
              >
                <div className="col-6 mt-3 mt-md-0 col-md-4">
                  <img
                    onClick={() => {
                      setShowModal(true);
                      setModalSrc("/4-cocuk-odası.jpg");
                    }}
                    width="100%"
                    height="auto"
                    src="/4-cocuk-odası.jpg"
                  />
                </div>
                <div className="col-6 mt-3 mt-md-0 col-md-3">
                  <img
